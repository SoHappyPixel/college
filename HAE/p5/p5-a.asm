...
;p5-a.c,20 :: 		void interrupt() //se ha pulsado una tecla
;p5-a.c,22 :: 		key=tecla();
	CALL        _tecla+0, 0
	MOVF        R0, 0 
	MOVWF       _key+0 
;p5-a.c,23 :: 		Lcd_chr(1,1,key);
	MOVLW       1
...
;p5-a.c,29 :: 		void main()
;p5-a.c,32 :: 		TRISB=0xF0;
	MOVLW       240
	MOVWF       TRISB+0 
;p5-a.c,33 :: 		PORTB=0;
	CLRF        PORTB+0 
;p5-a.c,36 :: 		INTCON2.RBPU=0; //se habilitan las resistencias de pullup de las entradas del PORTB
	BCF         INTCON2+0, 7 
;p5-a.c,37 :: 		x=PORTB;//para poder borrar el RBIF
	MOVF        PORTB+0, 0 
	MOVWF       _x+0 
;p5-a.c,38 :: 		INTCON.RBIF=0;
	BCF         INTCON+0, 0 
;p5-a.c,39 :: 		INTCON.RBIE=1;
	BSF         INTCON+0, 3 
;p5-a.c,40 :: 		INTCON.GIE=1;
	BSF         INTCON+0, 7 
;p5-a.c,42 :: 		Lcd_Init ();
	CALL        _Lcd_Init+0, 0
;p5-a.c,44 :: 		}
